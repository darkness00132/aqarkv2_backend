...
using Domain.Enums;
    ...
    namespace Application.Services
    {
        public class AdService : IAdService
        {
            ...
            public AdService(IStorageService storageService, IMapper mapper, IAdRepo adRepo, IImageRepo imageRepo, ICreditsRepo creditsRepo, IAdLogRepo adLogRepo, ICreditsLogRepo creditsLogRepo, LocationService locationService, IUnitOfWork uow)
            {
